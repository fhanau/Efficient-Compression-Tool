...
void ZopfliLZ77Optimal2(const ZopfliOptions* options, const unsigned char* in, size_t instart, size_t inend, ZopfliLZ77Store* store, unsigned char first, SymbolStats* statsp, unsigned mfinexport);
