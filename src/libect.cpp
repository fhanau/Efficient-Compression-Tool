...
static void ect_options_to_internal(const LibECTOptions* options, struct ECTOptions* internal) {
  ...
  switch (options->png_all_filters_mode) {
    case ECT_PNG_ALL_FILTERS_OFF:
      internal->Allfilters = 0;
      internal->Allfiltersbrute = 0;
      break;
    case ECT_PNG_ALL_FILTERS_NORMAL:
      internal->Allfilters = 1;
      internal->Allfiltersbrute = 0;
      break;
    case ECT_PNG_ALL_FILTERS_BRUTEFORCE:
      internal->Allfilters = 1;
      internal->Allfiltersbrute = 1;
      break;
  }
