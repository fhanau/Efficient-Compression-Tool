...
#define ECT_COMPRESSION_LEVEL_MIN 1
#define ECT_COMPRESSION_LEVEL_MAX 9
#define ECT_COMPRESSION_LEVEL_DEFAULT 3

#define ECT_PNG_PALETTE_SORT_MIN 0
#define ECT_PNG_PALETTE_SORT_MAX 120
